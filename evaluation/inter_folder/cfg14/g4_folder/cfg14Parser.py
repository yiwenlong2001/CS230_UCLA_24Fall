...
def serializedATN():
    return [
        ...
        5,0,0,1,26,27,3,2,1,0,27,28,3,10,5,0,28,30,1,0,0,0,29,25,1,0,0,0,
        29,26,1,0,0,0,30,9,1,0,0,0,31,36,5,0,0,1,32,33,3,2,1,0,33,34,3,12,
        6,0,34,36,1,0,0,0,35,31,1,0,0,0,35,32,1,0,0,0,36,11,1,0,0,0,37,38,
        5,0,0,1,38,13,1,0,0,0,2,29,35
    ]
...
class cfg14Parser ( Parser ):
    ...
    class S4Context(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(cfg14Parser.EOF, 0)
