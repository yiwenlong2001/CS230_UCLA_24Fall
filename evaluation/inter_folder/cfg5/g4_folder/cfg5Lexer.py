...
def serializedATN():
    return [
        ...
        9,10,5,97,0,0,10,2,1,0,0,0,11,12,5,101,0,0,12,4,1,0,0,0,13,14,5,
        99,0,0,14,6,1,0,0,0,15,17,7,0,0,0,16,15,1,0,0,0,17,18,1,0,0,0,18,
        16,1,0,0,0,18,19,1,0,0,0,19,20,1,0,0,0,20,21,6,3,0,0,21,8,1,0,0,
        0,2,0,18,1,6,0,0
    ]

class cfg5Lexer(Lexer):
