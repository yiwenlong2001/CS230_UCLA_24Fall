...
class cfg26Parser ( Parser ):
    ...
    class SContext(ParserRuleContext):
        ...
        def s2(self):
            return self.getTypedRuleContext(cfg26Parser.S2Context,0)


        def getRuleIndex(self):
            return cfg26Parser.RULE_s
    ...
    def s(self):
        ...
        localctx = cfg26Parser.SContext(self, self._ctx, self.state)
    ...
    def s1(self):
        ...
        localctx = cfg26Parser.S1Context(self, self._ctx, self.state)
        self.enterRule(localctx, 2, self.RULE_s1)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 18
            self.match(cfg26Parser.T__0)
            self.state = 19
            self.match(cfg26Parser.T__1)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class S2Context(ParserRuleContext):
        ...
        def s1(self):
            return self.getTypedRuleContext(cfg26Parser.S1Context,0)


        def s3(self):
            return self.getTypedRuleContext(cfg26Parser.S3Context,0)


        def getRuleIndex(self):
            return cfg26Parser.RULE_s2
    ...
    def s2(self):
        ...
        localctx = cfg26Parser.S2Context(self, self._ctx, self.state)
    ...
    class S3Context(ParserRuleContext):
        ...
        def s4(self):
            return self.getTypedRuleContext(cfg26Parser.S4Context,0)


        def getRuleIndex(self):
            return cfg26Parser.RULE_s3
    ...
    def s3(self):
        ...
        localctx = cfg26Parser.S3Context(self, self._ctx, self.state)
    ...
    class S4Context(ParserRuleContext):
        ...
        def s5(self):
            return self.getTypedRuleContext(cfg26Parser.S5Context,0)


        def getRuleIndex(self):
            return cfg26Parser.RULE_s4
    ...
    def s4(self):
        ...
        localctx = cfg26Parser.S4Context(self, self._ctx, self.state)
    ...
    class S5Context(ParserRuleContext):
        ...
        def s6(self):
            return self.getTypedRuleContext(cfg26Parser.S6Context,0)


        def getRuleIndex(self):
            return cfg26Parser.RULE_s5
    ...
    def s5(self):
        ...
        localctx = cfg26Parser.S5Context(self, self._ctx, self.state)
    ...
    class S6Context(ParserRuleContext):
        ...
        def s7(self):
            return self.getTypedRuleContext(cfg26Parser.S7Context,0)


        def getRuleIndex(self):
            return cfg26Parser.RULE_s6
    ...
    def s6(self):
        ...
        localctx = cfg26Parser.S6Context(self, self._ctx, self.state)
    ...
    def s7(self):
        ...
        localctx = cfg26Parser.S7Context(self, self._ctx, self.state)
