...
def serializedATN():
    return [
        ...
        0,0,5,12,1,0,0,0,7,8,5,100,0,0,8,2,1,0,0,0,9,10,5,97,0,0,10,4,1,
        0,0,0,11,13,7,0,0,0,12,11,1,0,0,0,13,14,1,0,0,0,14,12,1,0,0,0,14,
        15,1,0,0,0,15,16,1,0,0,0,16,17,6,2,0,0,17,6,1,0,0,0,2,0,14,1,6,0,
        0
    ]

class cfg2Lexer(Lexer):
